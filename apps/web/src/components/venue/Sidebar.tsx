...
export function VenueSidebar({
  ...
  const navItems = [
    ...
    { route: "leads" as UIRoute, label: "Leads", icon: Building2 },
    { route: "calendar" as UIRoute, label: "Calendar", icon: Calendar },
    { route: "messages" as UIRoute, label: "Messages", icon: MessageSquare },
